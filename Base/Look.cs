...
{
	public readonly static int STAND_EXTENT;

	public readonly static int CROUCH_EXTENT;

	public readonly static int PRONE_EXTENT;

	public readonly static int CLIMB_EXTENT;

	public readonly static int SWIM_EXTENT;
	...
	static Look()
	{
		Look.STAND_EXTENT = 85;
		Look.CROUCH_EXTENT = 70;
		Look.PRONE_EXTENT = 20;
		Look.CLIMB_EXTENT = 10;
		Look.SWIM_EXTENT = 60;
	}
	...
	public void Update()
	{
		...
		camera.fieldOfView = Mathf.Lerp(single, single1 + (float)obj, 4f * Time.deltaTime);
