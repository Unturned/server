...
namespace AdminCommands
{
    public class HomeCommands : MonoBehaviour
    {
        ...
        private readonly string PLAYER_HOME_PATH = @"config/playerHomes.txt";

        void Start()
        {
            if (!File.Exists(PLAYER_HOME_PATH))
            {
                StreamWriter streamWriter = new StreamWriter(PLAYER_HOME_PATH, true);
                streamWriter.WriteLine("");
                streamWriter.Close();
            }

            string[] homes = File.ReadAllLines(PLAYER_HOME_PATH);
        ...
        private IEnumerator SetHomeLocation(object[] args)
        {
            ...
            if (user.position.Equals(originalPosition))
            {
                ...
                {
                    string[] array = File.ReadAllLines(PLAYER_HOME_PATH);
                    File.Delete(PLAYER_HOME_PATH);
                    StreamWriter streamWriter = new StreamWriter(PLAYER_HOME_PATH, true);
                ...
                StreamWriter writer = new StreamWriter(PLAYER_HOME_PATH, true);
