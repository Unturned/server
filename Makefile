...
EXTRA_DIST =  rules.make configure Makefile.include libs/Assembly-CSharp-firstpass.dll libs/Assembly-UnityScript-firstpass.dll libs/UnityEngine.dll libs/UnityScript.Lang.dll
...
ifeq ($(CONFIG),DEBUG)
 SUBDIRS =  Assembly-CSharp AdminCommands UnturnedTest
endif
ifeq ($(CONFIG),RELEASE)
 SUBDIRS =  Assembly-CSharp AdminCommands UnturnedTest
endif
